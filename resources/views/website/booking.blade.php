													...
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															...
															<div class="modal-body">
																...
																<div class="form-group">
																	<div class="input-group date">
																		<input type="text" name="datein" id="datein" class="form-control datemonth" placeholder="dd/mm/yyyy" required><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
																	</div>
																</div>
																<p>End Mouth</p>
																<div class="form-group">
																	<div class="input-group date">
																		<input type="text" name="dateout" id="dateout" class="form-control datemonth" placeholder="dd/mm/yyyy" required><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
																	</div>
																</div>
																@endif
