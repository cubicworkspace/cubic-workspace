						...
						<div class="col-sm-8 col-md-9">
							...
							<div class="blog-wrapper">
								...
								<div class="blog-item">
									...
									<div class="blog-media">
										<div class="overlay-box">
											<a class="blog-image" href="detail_event.php">
								...
								<div class="blog-item">
									...
									<div class="blog-content">
										<h3><a href="detail_event.php" class="inverse">Another blog title post with a featured image</a></h3>
										<ul class="blog-meta clearfix">
											<li>by <a href="#">Admin</a></li>
											<li>by January 09, 2016</li>
											<li>in <a href="#">Adventure</a>, <a href="#">Backpack</a></li>
								...
								<div class="blog-item">
										...
										<div id="bootstrap-carousel-slider" class="carousel slide" data-ride="carousel" data-interval="5000">
											...
											<div class="carousel-inner" role="listbox">
												...
												<div class="item active">
													<div class="image">
														<img src="{{ asset('frontend/images/blog/blog-03.jpg') }}" alt="Image" />
													</div>
												...
												<div class="item">
													<div class="image">
														<img src="{{ asset('frontend/images/blog/blog-02.jpg') }}" alt="Image" />
													</div>
													<div class="carousel-caption">
												...
												<div class="item">
													<div class="image">
														<img src="{{ asset('frontend/images/blog/blog-01.jpg') }}" alt="Image" />
													</div>
													<div class="carousel-caption">
									...
									<div class="blog-content">
										<h3><a href="detail_event.php" class="inverse">Blog Title Post With a Slider</a></h3>
										<ul class="blog-meta clearfix">
											<li>by <a href="#">Admin</a></li>
											<li>by January 09, 2016</li>
											<li>in <a href="#">Adventure</a>, <a href="#">Backpack</a></li>
								...
								<div class="blog-item">
									...
									<div class="blog-content">
										<h3><a href="detail_event.php" class="inverse">Blog Title Post Without any Image</a></h3>
										<ul class="blog-meta clearfix">
											<li>by <a href="#">Admin</a></li>
											<li>by January 09, 2016</li>
											<li>in <a href="#">Adventure</a>, <a href="#">Backpack</a></li>
								...
								<div class="blog-item">
									...
									<div class="blog-content">
										<h3><a href="detail_event.php" class="inverse">Blog Title Post Viemo Video</a></h3>
										<ul class="blog-meta clearfix">
											<li>by <a href="#">Admin</a></li>
											<li>by January 09, 2016</li>
											<li>in <a href="#">Adventure</a>, <a href="#">Backpack</a></li>
								...
								<div class="blog-item">
									...
									<div class="blog-content">
										<h3><a href="detail_event.php" class="inverse">Blog Title Post Youtube Video</a></h3>
										<ul class="blog-meta clearfix">
											<li>by <a href="#">Admin</a></li>
											<li>by January 09, 2016</li>
											<li>in <a href="#">Adventure</a>, <a href="#">Backpack</a></li>
